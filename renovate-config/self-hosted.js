...
module.exports = {
  ...
  allowedCommands: [
    ...
    "^renovate-uv-lock-bounded --window P3D --exempt atlan-application-sdk --exempt atlan-application-sdk-conformance --exempt atlan-application-sdk-server --exempt pyatlan$",
