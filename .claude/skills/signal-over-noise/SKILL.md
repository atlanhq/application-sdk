...
> **Detection is now delegated to the conformance suite (P-series).** The P001–P018 checks
> run deterministically via `PYTHONPATH=conformance python -m suite.runner --repo . --series P`
