...
RULES: tuple[RuleDefinition, ...] = (
    ...
    RuleDefinition(
        ...
        full_description=(
            ...
            "check accepts either path, so a correctly generated bundle does not "
            "fire.  ``atlan.yaml`` stays in scope for both — a bundle root emits it "
            "too.\n"
            "\n"
            "Unlike K010, which exempts bundles outright, this rule checks both "
            "layouts so its coverage is preserved: a bundle that was never "
