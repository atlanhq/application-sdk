...
RULES: tuple[RuleDefinition, ...] = (
    ...
    RuleDefinition(
        ...
        rationale=(
            ...
            "empty over 3.22–3.26 (observed live on main for a document-store "
            ...
            "3.27.0 — so this rule now covers the no-extras case it always also "
        ...
        full_description=(
            ...
            "\n"
            "**Not the ``[daft]`` case — that one was ours.**  Over SDK 3.22–3.26\n"
            ...
            "root: from 3.27.0 ``[daft]`` aliases ``[sql]`` again, and a version\n"
