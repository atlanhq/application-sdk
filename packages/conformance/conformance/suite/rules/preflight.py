...
_CONTRACT_RULES = (
    RuleDefinition(
        ...
        rationale="Missing types and legacy output dictionaries hide contract drift from both UI and workflow consumers.",
    ...
    RuleDefinition(
        ...
        rationale="Static shape checks cannot prove verdict semantics, probe coverage, recovery, or resource lifetime. Missing and skipped scenarios are incomplete evidence.",
    ...
    RuleDefinition(
        ...
        rationale="Only execution history can prove extraction was never scheduled after a hard gate failure, including activity death.",
    ...
    RuleDefinition(
        ...
        rationale="Activity and workflow failures must preserve cause and status, and logging must not silently discard the evidence.",
