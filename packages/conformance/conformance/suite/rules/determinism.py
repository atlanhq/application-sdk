...
RULES: tuple[RuleDefinition, ...] = (
    ...
    RuleDefinition(
        ...
        full_description=(
            ...
            "s``; the nearest binding wins), or through a ``self.<attr>`` bound to\n"
            "one client in the methods of the same class (``__init__`` included,\n"
            "an initial ``None`` allowed, nested classes excluded).\n"
            "\n"
