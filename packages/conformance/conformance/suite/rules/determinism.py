...
RULES: tuple[RuleDefinition, ...] = (
    ...
    RuleDefinition(
        ...
        rationale=(
            ...
            "move, and the SafeFileOps wrappers over them) blocks for as long as the "
            ...
            "was network/sleep-only. The correct pattern is to await an async "
        ...
        full_description=(
            ...
            "SDK's ``SafeFileOps`` wrappers over them).  Await the coroutine\n"
            ...
            "thread hop, and flagging them would bury the tree-scale findings.  Tree\n"
            "*traversal* (``os.walk``, ``os.scandir``) is likewise out of scope for\n"
            "now.\n"
            "\n"
