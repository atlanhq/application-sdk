...
RULES: tuple[RuleDefinition, ...] = (
    ...
    RuleDefinition(
        ...
        full_description=(
            ...
            "(defaults to 0) or explicitly set to ``0``. Coverage is measured and\n"
            "reported (e.g. as a PR comment via the ``connector-unit-tests``\n"
            "composite action) but can never cause a run to fail, regardless of how\n"
            "low it drops.\n"
            "\n"
