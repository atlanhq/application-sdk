...
RULES: tuple[RuleDefinition, ...] = (
    RuleDefinition(
        ...
        full_description=(
            ...
            " declared alias routes the alias's target entry point: the declaration"
            " itself proves the node is this app's own, so no app-name or task-queue"
            " identity heuristic applies. A bare node **not** declared as an alias is"
            " a platform/other-app node (such as ``PublishWorkflow``) and routes"
            " nothing.\n"
            "\n"
