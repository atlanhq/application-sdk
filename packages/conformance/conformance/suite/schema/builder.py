...
Typical usage in a rule-checker::
    ...
    from conformance.suite.schema import ReportBuilder, load_catalog
    ...
    from conformance.suite.schema.sarif import Suppression, Location, PhysicalLocation, ArtifactLocation, Region
...
from conformance.suite.schema.disposition import Disposition, derive_disposition
from conformance.suite.schema.extensions import AtlanRunProperties, DispositionSummary
