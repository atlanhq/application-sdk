...
| [L002](#l002) | `NonCanonicalLoggerFactory` | `warn` | `both` | `log-format` | yes | 0.2.0 |
...
| [L019](#l019) | `DiscardedBindResult` | `warn` | `both` | `log-config` | — | 0.3.0 |
| [L020](#l020) | `DeprecatedLoggingWarn` | `warn` | `both` | `log-format` | yes | 0.3.0 |
| [L021](#l021) | `MissingLoggingLintRules` | `warn` | `both` | `log-config` | yes | 0.3.0 |
...
**Tier:** `warn` · **Scope:** `both` · **Category:** `log-config` · **Autofixable:** — · **Since:** 0.3.0
...
**Tier:** `warn` · **Scope:** `both` · **Category:** `log-format` · **Autofixable:** yes · **Since:** 0.3.0
...
**Tier:** `warn` · **Scope:** `both` · **Category:** `log-config` · **Autofixable:** yes · **Since:** 0.3.0
