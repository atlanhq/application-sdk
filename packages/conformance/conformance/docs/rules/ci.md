...
|---|---|---|---|---|---|---|---|
| [C001](#c001) | `UnpinnedActionReference` | `block` | `customer` | `both` | `supply-chain` | yes | 0.2.0 |
| [C002](#c002) | `BootstrapWorkflowDrift` | `warn` | `operational` | `app` | `ci-consistency` | yes | 0.3.0 |
| [C003](#c003) | `GitignoreMissingEntry` | `warn` | `hygiene` | `both` | `ci-consistency` | — | 0.4.0 |

---

## C001 — `UnpinnedActionReference` {#c001}

**Tier:** `block` · **Impact:** `customer` · **Scope:** `both` · **Category:** `supply-chain` · **Autofixable:** yes · **Since:** 0.2.0
...
**Tier:** `warn` · **Impact:** `operational` · **Scope:** `app` · **Category:** `ci-consistency` · **Autofixable:** yes · **Since:** 0.3.0
...
**Tier:** `warn` · **Impact:** `hygiene` · **Scope:** `both` · **Category:** `ci-consistency` · **Autofixable:** — · **Since:** 0.4.0
