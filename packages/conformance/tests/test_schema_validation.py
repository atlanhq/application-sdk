...
import jsonschema
import pytest
from conformance.suite.schema import ReportBuilder, load_catalog, validate_sarif
from conformance.suite.schema.sarif import Suppression
...
def test_golden_example_has_four_dispositions() -> None:
    ...
    from conformance.suite.schema import Disposition, SarifReport, derive_disposition
