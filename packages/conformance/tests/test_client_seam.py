...
def test_p019_silent_on_dapr_sidecar() -> None:
    src = 'import httpx\nhttpx.post("http://localhost:3500/v1.0/state/statestore")\n'
    assert _rule(src) == []


def test_p019_silent_on_segment_analytics() -> None:
    src = 'import httpx\nhttpx.post("https://api.segment.io/v1/batch")\n'
    assert _rule(src) == []


def test_p019_silent_on_prometheus_pushgateway() -> None:
    src = 'import httpx\nhttpx.get("http://127.0.0.1:9464/metrics")\n'
    assert _rule(src) == []


def test_p019_silent_on_third_party_connector_api() -> None:
    src = 'import httpx\nhttpx.get("https://api.github.com/repos/x/y")\n'
    assert _rule(src) == []


def test_p019_silent_on_urllib_parse_helpers() -> None:
...
def test_p019_silent_on_pyatlan_construction() -> None:
...
def test_p019_silent_on_atlan_marker_without_http_import() -> None:
...
def test_p019_silent_on_http_without_atlan_marker() -> None:
...
def test_p019_suppressed_inline() -> None:
    src = (
        "import httpx\n"
