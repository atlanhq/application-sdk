...
class MCPServer:
    ...
    def __init__(self, mcp_name: str, workflow_client=None):
        """
    ...
    def _register_activity_as_tool(
        self, activity_method, activities_class: Type[ActivitiesInterface]
    ):
    ...
    def get_asgi_app(self):
        ...
        if self.fastmcp_server is None:
            logger.error(
                "FastMCP server not initialized. Call discover_and_register_tools() first."
            )
            return None
