...
class InMemorySubscription:
    ...
    def __init__(self, topic: str, pubsub: "InMemoryPubSub") -> None:
        self._topic = topic
        self._pubsub = pubsub
        self._active = True
...
class InMemoryPubSub:
    ...
    def __init__(self) -> None:
        self._subscriptions: dict[
            str, list[tuple[MessageHandler, InMemorySubscription]]
        ] = {}
    ...
    async def subscribe(
        ...
        subscription = InMemorySubscription(topic, self)
    ...
    def _remove_subscription(
        ...
        """Remove a subscription (called by InMemorySubscription)."""
        if topic in self._subscriptions:
            self._subscriptions[topic] = [
    ...
    def clear(self) -> None:
        """Clear all subscriptions and published messages (for testing)."""
