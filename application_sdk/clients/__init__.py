"""Base client for all connector types.

Provides ``BaseClient`` — the root class for all connector clients.
...
Hierarchy::
    ...
    BaseClient                       ← this module
           │
    ┌──────┼──────────┐
    BaseSQLClient  BaseHTTPClient  AzureClient
"""
...
class BaseClient:
    ...
    Protocol-specific subclasses (``BaseSQLClient``, ``BaseHTTPClient``,
