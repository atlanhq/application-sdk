...
class MessageProcessorConfig(BaseModel):
    ...
    Attributes:
        pubsub_component_name: Name of the input pubsub component
    ...
    pubsub_component_name: str = Field(..., description="Name of the Messaging pubsub component")
    topic: str = Field(..., description="Name of the Messaging topic")
