...
class JSONChunkedObjectStoreWriter(ChunkedObjectStoreWriterInterface):
    ...
    async def write(self, data: Dict[str, Any]) -> None:
        async with self.lock:
            ...
            await self.current_file.write(orjson.dumps(
                data, option=orjson.OPT_APPEND_NEWLINE).decode("utf-8"))
    ...
    async def _create_new_file(self):
        ...
        self.current_file_name = f"{self.local_file_prefix}_{self.current_file_number}.json"
