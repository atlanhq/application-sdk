...
# keyword here matches — ODBC connectors do not use ``password=``. The
# character class already stops at ``;``, the ODBC separator, so the following
# key=value pair survives.
