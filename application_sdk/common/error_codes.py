...
# Client Errors
CLIENT_ERRORS = {
    "REQUEST_VALIDATION_ERROR": ErrorCode("Client", "403", "00", "Request validation failed"),
    "INPUT_VALIDATION_ERROR": ErrorCode("Client", "403", "01", "Input validation failed"),
    "CLIENT_AUTH_ERROR": ErrorCode("Client", "401", "00", "Client authentication failed"),
    "HANDLER_AUTH_ERROR": ErrorCode("Client", "401", "01", "Handler authentication failed"),
    "SQL_CLIENT_AUTH_ERROR": ErrorCode("Client", "401", "02", "SQL client authentication failed"),
}
...
FASTAPI_ERRORS = {
    ...
    "SERVER_CONFIG_ERROR": ErrorCode("FastApi", "500", "00", "Server configuration error"),
    "CONFIGURATION_ERROR": ErrorCode("FastApi", "500", "01", "General configuration error"),
    "LOGGER_SETUP_ERROR": ErrorCode("FastApi", "500", "02", "Logger setup failed"),
    "LOGGER_PROCESSING_ERROR": ErrorCode("FastApi", "500", "03", "Error processing log record"),
...
# Temporal Errors
TEMPORAL_ERRORS = {
    "TEMPORAL_CLIENT_CONNECTION_ERROR": ErrorCode("Temporal", "403", "00", "Temporal client connection error"),
    "TEMPORAL_CLIENT_ACTIVITY_ERROR": ErrorCode("Temporal", "500", "00", "Temporal client activity error"),
    "TEMPORAL_CLIENT_WORKER_ERROR": ErrorCode("Temporal", "500", "01", "Temporal client worker error"),
}

# Temporal Workflow Errors
TEMPORAL_WORKFLOW_ERRORS = {
    "WORKFLOW_EXECUTION_ERROR": ErrorCode("TemporalWorkflow", "500", "02", "Workflow execution error"),
    "WORKFLOW_CONFIG_ERROR": ErrorCode("TemporalWorkflow", "400", "00", "Workflow configuration error"),
    "WORKFLOW_VALIDATION_ERROR": ErrorCode("TemporalWorkflow", "422", "00", "Workflow validation error"),
    "WORKFLOW_CLIENT_START_ERROR": ErrorCode("TemporalWorkflow", "500", "03", "Workflow client start error"),
    "WORKFLOW_CLIENT_STOP_ERROR": ErrorCode("TemporalWorkflow", "500", "04", "Workflow client stop error"),
    "WORKFLOW_CLIENT_STATUS_ERROR": ErrorCode("TemporalWorkflow", "500", "05", "Workflow client status error"),
    "WORKFLOW_CLIENT_WORKER_ERROR": ErrorCode("TemporalWorkflow", "500", "06", "Workflow client worker error"),
    "WORKFLOW_CLIENT_NOT_FOUND_ERROR": ErrorCode("TemporalWorkflow", "404", "00", "Workflow client not found"),
}
...
IO_ERRORS = {
    ...
    "PARQUET_VALIDATION_ERROR": ErrorCode("IO", "500", "12", "Parquet validation error"),
    ...
    "OBJECT_STORE_DOWNLOAD_ERROR": ErrorCode("IO", "503", "00", "Object store download error"),
    ...
    "STATE_STORE_EXTRACT_ERROR": ErrorCode("IO", "500", "18", "State store extract error"),
    "STATE_STORE_VALIDATION_ERROR": ErrorCode("IO", "500", "19", "State store validation error"),
    ...
    "PARQUET_DAFT_WRITE_ERROR": ErrorCode("IO", "500", "28", "Parquet daft write error"),
    "PARQUET_VALIDATION_ERROR": ErrorCode("IO", "500", "29", "Parquet validation error"),
    "ICEBERG_WRITE_ERROR": ErrorCode("IO", "500", "30", "Iceberg write error"),
    "ICEBERG_DAFT_WRITE_ERROR": ErrorCode("IO", "500", "31", "Iceberg daft write error"),
    "ICEBERG_TABLE_ERROR_OUT": ErrorCode("IO", "500", "32", "Iceberg table output error"),
    "OBJECT_STORE_WRITE_ERROR": ErrorCode("IO", "500", "33", "Object store write error"),
...
COMMON_ERRORS = {
    ...
    "FILTER_PREPARATION_ERROR": ErrorCode("Common", "400", "00", "Filter preparation error"),
    "CREDENTIALS_PARSE_ERROR": ErrorCode("Common", "400", "01", "Credentials parse error"),
}

# DocGen Errors
DOCGEN_ERRORS = {
    "DOCGEN_ERROR": ErrorCode("Docgen", "500", "00", "Documentation generation error"),
    "DOCGEN_EXPORT_ERROR": ErrorCode("Docgen", "500", "01", "Documentation export error"),
    ...
    "MANIFEST_VALIDATION_ERROR": ErrorCode("Docgen", "500", "04", "Manifest validation error"),
    "MANIFEST_YAML_ERROR": ErrorCode("Docgen", "422", "00", "Manifest YAML error"),
    "DIRECTORY_VALIDATION_ERROR": ErrorCode("Docgen", "500", "05", "Directory validation error"),
    "DIRECTORY_CONTENT_ERROR": ErrorCode("Docgen", "422", "01", "Directory content error"),
    "DIRECTORY_STRUCTURE_ERROR": ErrorCode("Docgen", "422", "02", "Directory structure error"),
    "DIRECTORY_FILE_ERROR": ErrorCode("Docgen", "422", "03", "Directory file error"),
    "MKDOCS_CONFIG_ERROR": ErrorCode("Docgen", "422", "04", "MkDocs configuration error"),
...
# Activity Errors
ACTIVITY_ERRORS = {
    "ACTIVITY_START_ERROR": ErrorCode("TemporalActivity", "503", "00", "Activity start error"),
    "ACTIVITY_END_ERROR": ErrorCode("TemporalActivity", "500", "00", "Activity end error"),
    "QUERY_EXTRACTION_ERROR": ErrorCode("TemporalActivity", "500", "01", "Query extraction error"),
    "QUERY_EXTRACTION_SQL_ERROR": ErrorCode("TemporalActivity", "500", "02", "Query extraction SQL error"),
    "QUERY_EXTRACTION_PARSE_ERROR": ErrorCode("TemporalActivity", "500", "03", "Query extraction parse error"),
    "QUERY_EXTRACTION_VALIDATION_ERROR": ErrorCode("TemporalActivity", "422", "00", "Query extraction validation error"),
    "METADATA_EXTRACTION_ERROR": ErrorCode("TemporalActivity", "500", "04", "Metadata extraction error"),
    "METADATA_EXTRACTION_SQL_ERROR": ErrorCode("TemporalActivity", "500", "05", "Metadata extraction SQL error"),
    "METADATA_EXTRACTION_REST_ERROR": ErrorCode("TemporalActivity", "500", "06", "Metadata extraction REST error"),
    "METADATA_EXTRACTION_PARSE_ERROR": ErrorCode("TemporalActivity", "500", "07", "Metadata extraction parse error"),
    "METADATA_EXTRACTION_VALIDATION_ERROR": ErrorCode("TemporalActivity", "422", "01", "Metadata extraction validation error"),
}
