...
async def download_s3_prefix_with_structure(
    ...
    directory structure locally. For example:
        S3: persistent-artifacts/apps/default/connection/123/current-state/table/chunk-0.json
        Local: /tmp/.../current-state/table/chunk-0.json
