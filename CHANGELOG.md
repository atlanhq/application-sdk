...
## v1.0.0rc1 (November 22, 2025)

Full Changelog: https://github.com/atlanhq/application-sdk/compare/v1.0.0...v1.0.0rc1

### Features

- basic docs enhancements (#460) (by @inishchith in [1983e79](https://github.com/atlanhq/application-sdk/commit/1983e79))
- fix pipeline (#468) (by @junaidrahim in [f6fc5b7](https://github.com/atlanhq/application-sdk/commit/f6fc5b7))
- Improve release flow - Github and PyPi (by @inishchith in [e96c2b7](https://github.com/atlanhq/application-sdk/commit/e96c2b7))
- Add SQL based transformer mapper (#423) (by @OnkarVO7 in [459e806](https://github.com/atlanhq/application-sdk/commit/459e806))
- migrate to uv, goodbye poetry (#485) (by @inishchith in [6f0570f](https://github.com/atlanhq/application-sdk/commit/6f0570f))
...
- develop to main (#553) (by @inishchith in [e4dee9c](https://github.com/atlanhq/application-sdk/commit/e4dee9c))
- Add SQLAlchemy url support (#561) (by @OnkarVO7 in [67bc050](https://github.com/atlanhq/application-sdk/commit/67bc050))
- add support for sync activity executor (#563) (by @inishchith in [fe5f396](https://github.com/atlanhq/application-sdk/commit/fe5f396))
- add observability decorator (#559) (by @abhishekagrawal-atlan in [1dd4c82](https://github.com/atlanhq/application-sdk/commit/1dd4c82))
...
- Improve attribute definitions in yaml templates for SQL transformer (#528) (by @OnkarVO7 in [be2cbd0](https://github.com/atlanhq/application-sdk/commit/be2cbd0))
- observability improvements (#584) (by @SanilK2108 in [cc11cb9](https://github.com/atlanhq/application-sdk/commit/cc11cb9))
- Add application-sdk support to write markers during query extraction (#599) (by @abhishekagrawal-atlan in [1d97e81](https://github.com/atlanhq/application-sdk/commit/1d97e81))
- enable tests and examples on macOS and windows as part of CI (#606) (by @inishchith in [e717fa0](https://github.com/atlanhq/application-sdk/commit/e717fa0))
- use object store as state store, path update and fixes (#618) (by @inishchith in [d439cb4](https://github.com/atlanhq/application-sdk/commit/d439cb4))
- Add utility function to fetch include/exclude databases from include-exclude regex (#623) (by @abhishekagrawal-atlan in [0c6cc62](https://github.com/atlanhq/application-sdk/commit/0c6cc62))
...
- add cursor and bugbot rules (#636) (by @firecast in [cbbecd9](https://github.com/atlanhq/application-sdk/commit/cbbecd9))
- add pyatlan Client to Application SDK (#642) (by @ErnestoLoma in [c00d682](https://github.com/atlanhq/application-sdk/commit/c00d682))
- increase DAPR gRPC message limit from 16MB to 100MB (#649) (by @inishchith in [ae0d218](https://github.com/atlanhq/application-sdk/commit/ae0d218))
- support for app registration via events (#635) (by @inishchith in [330b585](https://github.com/atlanhq/application-sdk/commit/330b585))
- Generic Client and Handlers for non-SQL connectors with http request methods (allows custom retry transport) (#660) (by @prateek11rai in [b077a90](https://github.com/atlanhq/application-sdk/commit/b077a90))
- improve services abstraction (#658) (by @inishchith in [73cf5e4](https://github.com/atlanhq/application-sdk/commit/73cf5e4))
- implement abstract methods in BaseHandler (by @TechyMT in [c7c1937](https://github.com/atlanhq/application-sdk/commit/c7c1937))
- implement Redis client with sync/async support and distributed locking (#621) (by @TechyMT in [e384ceb](https://github.com/atlanhq/application-sdk/commit/e384ceb))
- Update to pyatlan 8.0.2 to get fix for AsyncWorkflowSearchResponse async iterator (#680) (by @ErnestoLoma in [a33bc4c](https://github.com/atlanhq/application-sdk/commit/a33bc4c))
- add file size-based chunking to JsonOutput (#650) (by @inishchith in [7e7685b](https://github.com/atlanhq/application-sdk/commit/7e7685b))
- add Daft configuration constants and update Parquet output handling (by @TechyMT in [68c2593](https://github.com/atlanhq/application-sdk/commit/68c2593))
- implement delete file and prefix operations in ObjectStore (#694) (by @TechyMT in [6f71615](https://github.com/atlanhq/application-sdk/commit/6f71615))
- enhance bugbot rules (#681) (by @AdvitXAtlan in [546d23f](https://github.com/atlanhq/application-sdk/commit/546d23f))
- add retain_local_copy option to upload methods in ObjectStore (#691) (by @TechyMT in [38285f0](https://github.com/atlanhq/application-sdk/commit/38285f0))
- add support for frontend configmap handler and static file serving (#631) (by @AngadSethi in [13e164a](https://github.com/atlanhq/application-sdk/commit/13e164a))
- add support for multidb extraction, enhance aws client via redshift refactor (#706) (by @abhishekagrawal-atlan in [4441285](https://github.com/atlanhq/application-sdk/commit/4441285))
- enhance file handling in Input classes (#697) (by @TechyMT in [a792fa6](https://github.com/atlanhq/application-sdk/commit/a792fa6))
- update configuration documentation with comprehensive constant descriptions and use cases (#646) (by @inishchith in [6f91796](https://github.com/atlanhq/application-sdk/commit/6f91796))
- add minimal API docs for endpoints exposed (#721) (by @inishchith in [3301b61](https://github.com/atlanhq/application-sdk/commit/3301b61))
- fix credentials and extra field information in docs (#724) (by @inishchith in [a0808db](https://github.com/atlanhq/application-sdk/commit/a0808db))
...
- GA release (#825) (by @firecast in [76420ae](https://github.com/atlanhq/application-sdk/commit/76420ae))

### Bug Fixes

- remove redundant dependency (pylint) (by @inishchith in [55d0169](https://github.com/atlanhq/application-sdk/commit/55d0169))
- date datatype in transformed output (by @OnkarVO7 in [032bbbd](https://github.com/atlanhq/application-sdk/commit/032bbbd))
- sql transformer diff (#511) (by @OnkarVO7 in [5641a7a](https://github.com/atlanhq/application-sdk/commit/5641a7a))
...
- Observability (duckDB UI) (#556) (by @abhishekagrawal-atlan in [d06b52a](https://github.com/atlanhq/application-sdk/commit/d06b52a))
- issue with retrieving workflow args (#562) (by @inishchith in [1f3f194](https://github.com/atlanhq/application-sdk/commit/1f3f194))
- Pandas read_sql for Redshift adbc connection (#572) (by @OnkarVO7 in [183d204](https://github.com/atlanhq/application-sdk/commit/183d204))
- update compiled_url_logic (#574) (by @OnkarVO7 in [c1c6253](https://github.com/atlanhq/application-sdk/commit/c1c6253))
- dapr limit while file upload (#576) (by @OnkarVO7 in [32f63d6](https://github.com/atlanhq/application-sdk/commit/32f63d6))
- workflow argument handling in test classes (#582) (by @TechyMT in [01ab925](https://github.com/atlanhq/application-sdk/commit/01ab925))
- Fetch queries activity in SQLQueryExtractionActivities (#587) (by @abhishekagrawal-atlan in [708f783](https://github.com/atlanhq/application-sdk/commit/708f783))
- setup_workflow method for metadata_extraction (#583) (by @abhishekagrawal-atlan in [1e00f7e](https://github.com/atlanhq/application-sdk/commit/1e00f7e))
...
- defaults for fetch_metadata endpoint, simplify handler (#598) (by @inishchith in [1c7f0ff](https://github.com/atlanhq/application-sdk/commit/1c7f0ff))
- uvloop not supported for windows, docs (#604) (by @inishchith in [bd07e9f](https://github.com/atlanhq/application-sdk/commit/bd07e9f))
- unit tests structure, add missing tests (#609) (by @inishchith in [b146004](https://github.com/atlanhq/application-sdk/commit/b146004))
- multi-database fetch based on include / exclude filter (#610) (by @abhishekagrawal-atlan in [954584e](https://github.com/atlanhq/application-sdk/commit/954584e))
- suppress daft dependency loggers (#611) (by @inishchith in [3e379d4](https://github.com/atlanhq/application-sdk/commit/3e379d4))
- issues with inferring workflow_run_id (#624) (by @inishchith in [61e7a4d](https://github.com/atlanhq/application-sdk/commit/61e7a4d))
- marker file being saved at incorrect location (#620) (by @abhishekagrawal-atlan in [d3de56f](https://github.com/atlanhq/application-sdk/commit/d3de56f))
- db name regex pattern (#630) (by @OnkarVO7 in [bb26992](https://github.com/atlanhq/application-sdk/commit/bb26992))
- handle str and dict types in preflight checks (#638) (by @inishchith in [57ee9a0](https://github.com/atlanhq/application-sdk/commit/57ee9a0))
- cleanup local path post upload to object store (#640) (by @inishchith in [4195425](https://github.com/atlanhq/application-sdk/commit/4195425))
- replace getdaft with daft (#639) (by @inishchith in [de79e93](https://github.com/atlanhq/application-sdk/commit/de79e93))
- remove ATLAN_LOCAL_DEVELOPMENT env, infer usage based on components (#641) (by @inishchith in [58462e7](https://github.com/atlanhq/application-sdk/commit/58462e7))
- error logs for eventstore, objectstore and metrics (#647) (by @inishchith in [70b71b6](https://github.com/atlanhq/application-sdk/commit/70b71b6))
- download_files_from_object_store with correct files list (#652) (by @inishchith in [e2ed7bd](https://github.com/atlanhq/application-sdk/commit/e2ed7bd))
- error logs related to deployment secrets (#651) (by @inishchith in [09f6e5c](https://github.com/atlanhq/application-sdk/commit/09f6e5c))
- Parquet file output path with None file names (#659) (by @OnkarVO7 in [8841660](https://github.com/atlanhq/application-sdk/commit/8841660))
- file references in cursor rules (#662) (by @inishchith in [2395ce3](https://github.com/atlanhq/application-sdk/commit/2395ce3))
- update app host (#664) (by @OnkarVO7 in [24d23cb](https://github.com/atlanhq/application-sdk/commit/24d23cb))
- make sql client use context managers (#699) (by @inishchith in [211f31b](https://github.com/atlanhq/application-sdk/commit/211f31b))
- file not found exception across cloud providers, suppress logs in case of upsert (#702) (by @inishchith in [0089c5f](https://github.com/atlanhq/application-sdk/commit/0089c5f))
- memory management issues with readers and writers (#700) (by @inishchith in [af77ed9](https://github.com/atlanhq/application-sdk/commit/af77ed9))
- Fix semaphore implementation to allow multiple batching without getting into max_concurrent_activities issue (#725) (by @TechyMT in [2a66f13](https://github.com/atlanhq/application-sdk/commit/2a66f13))
- CI build path (#733) (by @inishchith in [6d04006](https://github.com/atlanhq/application-sdk/commit/6d04006))
- Update ParquetOutput to handle file uploads correctly (#732) (by @TechyMT in [b4b2953](https://github.com/atlanhq/application-sdk/commit/b4b2953))
- partition columns defaults for daft write_parquet (#728) (by @inishchith in [7ed4949](https://github.com/atlanhq/application-sdk/commit/7ed4949))
- Updated constants + Refactor for multidb logic (#736) (by @abhishekagrawal-atlan in [cd97be3](https://github.com/atlanhq/application-sdk/commit/cd97be3))
