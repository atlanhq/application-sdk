...
MODULE_MAP: dict[str, tuple[str, bool, str]] = {
    ...
    "application_sdk.clients.temporal": (
        "application_sdk.execution._temporal.worker",
        False,
        "",
    ),
    ...
    "application_sdk.interceptors.cleanup": (
        "application_sdk.execution._temporal.interceptors.cleanup",
        False,
        "",
    ),
    "application_sdk.interceptors.lock": (
        "application_sdk.execution._temporal.interceptors.lock",
        False,
        "",
    ),
    "application_sdk.interceptors.correlation_context": (
        "application_sdk.execution._temporal.interceptors.correlation_context",
        False,
        "",
    ),
    "application_sdk.interceptors.activity_failure_logging": (
        "application_sdk.execution._temporal.interceptors.activity_failure_logging",
        False,
        "",
    ),
    # Test utilities
