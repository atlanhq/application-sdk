...
class SelfhostedGeneratedE2EBase(SQLAppE2ETest):
    connector_short_name = "docstore"
    argo_package_name = "@atlan/docstore-server"
    argo_template_name = "atlan-docstore-server"
    ...
    manifest_path = "app/generated/selfhosted/manifest.json"
