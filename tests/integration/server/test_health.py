"""Integration tests for application_sdk.server.health.

These tests start a real TCP server on localhost — moved from tests/unit/server/test_health.py
when the unit suite was hardened with --disable-socket.  No external services (Dapr / Temporal)
are required; the tests use only localhost TCP connections.
"""
...
from application_sdk.server.health import WorkerHealthServer, run_health_server
