...
import pytest
from application_sdk.common.logger_adaptors import AtlanLoggerAdapter  # Assume this is the file where the class resides
...
def test_base_logger_property(logger_adapter: AtlanLoggerAdapter, mock_logger: logging.Logger):
