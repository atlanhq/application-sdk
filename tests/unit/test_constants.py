...
class TestLoadBuildInfo:
    ...
    def test_env_override_path(self, tmp_path, monkeypatch: pytest.MonkeyPatch):
        ...
        assert constants._load_build_info()["app_version"] == "9.9.9"
