...
- `docs/standards/ci-required-checks.md` — the always-run + short-circuit rule for required PR checks; read before adding or editing any CI check that is (or may become) a required status check.
