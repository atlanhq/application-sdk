...
- `docs/standards/symbols.md` — process for removing/renaming a Python symbol: you may not remove a name that was not already marked deprecated in the previous release. Enforced by the required Symbol Removal Check. Read it before deleting or renaming anything importable.
