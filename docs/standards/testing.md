...
- **Connector-App Testing Tiers (Agreed Architecture)**
  ...
  - **Integration** — connects to the real source, runs the app's extract
    ...
    mocked infra) (T011). For the full contract — invariants every suite
    must satisfy, the reference-repo comparison, and what's normative for
    credential handling — see
    [`docs/standards/integration-tier-contract.md`](./integration-tier-contract.md).
