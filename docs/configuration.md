...
| `ATLAN_CONTRACT_GENERATED_DIR` | Directory where generated contract JSON files (configmaps, manifest) are stored | `/app/app/contract/generated` (base image default; matches `app/contract/generated/` in repo) | Place generated files in `app/contract/generated/` so they are importable as `app.contract.generated`; override only if your layout differs |
