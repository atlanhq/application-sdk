...
# phase runs on gpt-6-sol — the same model the existing lanes review with
# — and the resolve phase on gpt-6-luna via opencode, both
...
#   secrets.LITELLM_API_KEY           gateway key entitled to BOTH gpt-6-sol
#                                     and gpt-6-luna. An unentitled model is a
