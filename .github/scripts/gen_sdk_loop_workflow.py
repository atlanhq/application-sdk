...
# through llmproxy.atlan.dev (public Cloudflare edge — no VPN, no mothership
# sandbox). Every phase reads the EXISTING playbooks from this checkout:
...
#   vars.LITELLM_BASE_URL             optional; defaults to llmproxy.atlan.dev
